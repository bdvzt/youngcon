...
struct YoungConLiveActivityEntryView: View {
...
struct YoungConLiveActivity: Widget {
    let kind: String = "YoungConLiveActivity"

    var body: some WidgetConfiguration {
        AppIntentConfiguration(kind: kind, intent: ConfigurationAppIntent.self, provider: Provider()) { entry in
            YoungConLiveActivityEntryView(entry: entry)
